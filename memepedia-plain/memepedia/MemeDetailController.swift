...
class MemeDetailController: UITableViewController, MemeAware {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            cell = tableView.dequeueReusableCell(withIdentifier: "detailImageCell", for: indexPath)
        default:
            cell = tableView.dequeueReusableCell(withIdentifier: "detailTextCell", for: indexPath)
        }
